nv.models.scatterZoomChart = function() {
  "use strict";
  //============================================================
    ...
    selection.each(function(data) {
      ...
      function reset(d,i) {
        d3.transition().duration(750).tween("zoom", function() {
            var ix = d3.interpolate(x.domain(), [-availableWidth / 2, availableWidth / 2]),
                iy = d3.interpolate(y.domain(), [-availableHeight / 2, availableHeight / 2]);
            return function(t) {
